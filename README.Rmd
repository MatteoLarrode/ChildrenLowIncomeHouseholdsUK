...
head(uc_children_reduced_df, 10)
```
...
The results of this first model show that for every 1 percentage point increase in households receiving UC, there is a 0.315 percentage point increase in the proportion of children living in low income families. This relationship is statistically significant at all conventional thresholds. 
...
uc_children_16_20_new_df <- uc_children_16_20_df |> 
  left_join(uc_first_active, by = "ltla21_code") |> 
  mutate(
...
We can visualise change in the increase in the proportion of children in low income families for every 1ppt increase in the proportion of households on UC, using the interaction term:
