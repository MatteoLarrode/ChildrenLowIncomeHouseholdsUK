...
unmatched_in_df1 <- anti_join(dataset_model1, ltla21_noNI, by = "ltla21_code")
...
# (= missing data)
unmatched_in_ltla21 <- anti_join(ltla21_noNI, dataset_model1, by = "ltla21_code")
